...
| 分支类型 | 分支名称 | 功能说明 |
| :------- | :------- | :------- |
| 主分支 | master | 稳定版本发布，从develop分支合并 |
| 开发分支 | develop | 开发整合分支，所有功能分支从这里创建 |
| 功能分支 | feature/math-foundations | 数学基础实验开发 |
| 功能分支 | feature/control-theory | 控制理论实验开发 |
| 功能分支 | feature/fuzzy-pid | 模糊PID控制器实现 |
| 功能分支 | feature/impedance-control | 阻抗控制实现 |
| 功能分支 | feature/adaptive-control | 自适应控制实现 |
| 功能分支 | feature/mpc | 模型预测控制实现 |
| 功能分支 | feature/matlab-simulink | MATLAB/Simulink实践 |
| 功能分支 | feature/cpp-eigen | C++/Eigen控制算法库开发 |
| 功能分支 | feature/rk3588 | RK3588开发板实验 |
...
2. **功能开发**：在对应分支上进行代码开发和测试

3. **代码提交**：
   ```bash
   git add .
   git commit -m "功能开发：详细描述修改内容"
   ```
...
1. **功能开发完成后**，在对应功能分支上更新相关文档

2. **合并到develop分支后**，在主分支README.md中记录以下内容：
   - 分支名称
   - 修改的主要内容
   - 影响的文件和功能
   - 版本更新信息

3. **版本发布时**，更新README.md中的项目状态和版本信息

### 分支文档记录规范

每次合并到主分支后，在README.md中添加以下格式的更新记录：

## 📝 分支更新记录

### [2025-12-09] feature/cpp-eigen
- **修改内容**：完成C++/Eigen控制算法库开发，实现了PID控制器的完整功能
- **影响文件**：
  - Experiments/Toolchain/cpp_control_lib/include/pid_controller.hpp
  - Experiments/Toolchain/cpp_control_lib/src/pid_controller.cpp
  - Experiments/Toolchain/cpp_control_lib/tests/test_simple.cpp
  - Experiments/Toolchain/cpp_control_lib/tests/test_pid.cpp
  - Experiments/Toolchain/cpp_control_lib/CMakeLists.txt
- **功能说明**：
  - 实现了比例-积分-微分控制算法
  - 添加了抗饱和处理
  - 支持参数调整和重置功能
...
### [2025-12-09] feature/math-foundations
- **修改内容**：数学基础实验开发，包括线性代数和ODE求解器
- **影响文件**：
  - Experiments/Math_Foundations/dc_motor_test.m
  - Experiments/Math_Foundations/linear_algebra.py
  - Experiments/ODE_Solvers/ode_solvers.py
- **功能说明**：
  - 实现了直流电机模型测试
  - 添加了线性代数基础代码
  - 实现了常微分方程数值求解器
...
### [2025-12-09] feature/matlab-simulink
- **修改内容**：MATLAB/Simulink实践，添加了PID响应可视化工具
- **影响文件**：
  - plot_pid_simple.m
  - plot_pid_analysis.m
- **功能说明**：
